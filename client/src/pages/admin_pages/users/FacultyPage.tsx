            ...
            <table className="min-w-full divide-y divide-gray-200">
                ...
                <tbody className="bg-white divide-y divide-gray-200">
                    {faculties.map((faculty) => (
                        <tr key={faculty._id}>
                            <td className="px-6 py-4 whitespace-nowrap">{faculty.facultyid}</td>
                            <td className="px-6 py-4 whitespace-nowrap">{faculty.fname}</td>
                            <td className="px-6 py-4 whitespace-nowrap">{faculty.lname}</td>
                            <td className="px-6 py-4 whitespace-nowrap">{faculty.emailadd}</td>
                            <td className="px-6 py-4 whitespace-nowrap">{faculty.phone}</td>
                            <td className="px-6 py-4 whitespace-nowrap">{faculty.birthday}</td>
                            <td className="px-6 py-4 whitespace-nowrap">{faculty.address}</td>
