...
function Signup() {
    ...
    const handleSubmit = (e: React.FormEvent<HTMLFormElement>) => {
        ...
        axios.post('http://localhost:3001/faculty', {facultyid, fname, lname, phone, emailadd,
            ...
            .catch(err => {
                console.log(err);
                toast.error("Error registering faculty!");
            });
    }

    return (
        <>
        <PageBreadcrumb pageTitle="Faculty Registration" />
            ...
            <div className="mx-auto">
                ...
                <div className="-mx-3 flex flex-wrap">
                    <div className="w-full px-3 sm:w-1/3">
                        <div className="mb-5">
                            <label htmlFor="facultyid" className="mb-3 block text-base font-medium text-gray-800 dark:text-white/90">
                                Faculty ID
                            </label>
                            <input type="text" name="facultyid" id="facultyid" placeholder="Faculty ID" value={facultyid}
                ...
                <div className="-mx-3 flex flex-wrap">
                    ...
                    <div className="w-full px-3 sm:w-1/2">
                        <div className="mb-5">
                            <label htmlFor="passwords" className="mb-3 block text-base font-medium text-gray-800 dark:text-white/90">
                                Password
                            </label>
