...
const StudentProfilePage = () => {
    const [userData, setUserData] = useState<{ studentid: string; lname: string; fname: string; phone: string; 
        emailadd: string; birthday: string; address: string; course: string; year: string; section: string } | null>(null);
